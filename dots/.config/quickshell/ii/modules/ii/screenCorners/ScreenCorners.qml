...
Scope {
    ...
    component CornerPanelWindow: PanelWindow {
        ...
        visible: (Appearance.fakeScreenRounding === 1 || (Appearance.fakeScreenRounding === 2 && !fullscreen))
        property var corner
    ...
    Variants {
        ...
        Scope {
            ...
            property bool fullscreen: !!HyprlandData.activeFullscreenWorkspaceForMonitor(monitor?.name)
